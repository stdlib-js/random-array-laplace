...
```javascript
laplace = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/random-array-laplace@umd/browser.js' )
```
The previous example will load the latest bundled code from the umd branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/random-array-laplace/tags). For example,

```javascript
laplace = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/random-array-laplace@v0.2.0-umd/browser.js' )
```

To vendor stdlib functionality and avoid installing dependency trees for Node.js, you can use the UMD server build:

```javascript
var laplace = require( 'path/to/vendor/umd/random-array-laplace/index.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/random-array-laplace@umd/browser.js"></script>
```
...
[test-image]: https://github.com/stdlib-js/random-array-laplace/actions/workflows/test.yml/badge.svg?branch=v0.2.0
[test-url]: https://github.com/stdlib-js/random-array-laplace/actions/workflows/test.yml?query=branch:v0.2.0
...
[dependencies-image]: https://img.shields.io/david/stdlib-js/random-array-laplace.svg
[dependencies-url]: https://david-dm.org/stdlib-js/random-array-laplace/main
...
[deno-url]: https://github.com/stdlib-js/random-array-laplace/tree/deno
[deno-readme]: https://github.com/stdlib-js/random-array-laplace/blob/deno/README.md
[umd-url]: https://github.com/stdlib-js/random-array-laplace/tree/umd
[umd-readme]: https://github.com/stdlib-js/random-array-laplace/blob/umd/README.md
[esm-url]: https://github.com/stdlib-js/random-array-laplace/tree/esm
[esm-readme]: https://github.com/stdlib-js/random-array-laplace/blob/esm/README.md
[branches-url]: https://github.com/stdlib-js/random-array-laplace/blob/main/branches.md

[stdlib-license]: https://raw.githubusercontent.com/stdlib-js/random-array-laplace/main/LICENSE
